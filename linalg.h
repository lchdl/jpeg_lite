/* defines and implements a simple linear algebra system */

#pragma once

/* GLOBAL SETTING: use single/double precision floats */
#define LINALG_USE_SINGLE_PRECISION /* or "LINALG_USE_DOUBLE_PRECISION" */
//#define LINALG_USE_DOUBLE_PRECISION
...
#ifdef LINALG_USE_DOUBLE_PRECISION
typedef double REAL;
#define Sqrt   sqrt
#define Sin    sin
#define Cos    cos
